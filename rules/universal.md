...
6. **Existing patterns win.** Read `{{CONTEXT_DIR}}/design-patterns/DESIGN-PATTERNS.md` before introducing a new convention. If an existing pattern covers the case, use it.
